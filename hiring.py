#Niki
#Challenge 4
#Find all applicants who know Python for a position that requires a programmer with knowledge of python. Years of experience does not matter for this applicant.
#Init
# Applicant Names
names = [
...
filtered_applicants=[]
#Functions
def search(skill,years):
    for i in range(len(names)):
        if experience[i] >= years and skill in expertise[i]:
            filtered_applicants.append(names[i])
    print(filtered_applicants)
    filtered_applicants.clear()
#Main
search("Security",5)
